...
public:
    ...
    void setupUi(QWidget *mywidget)
    {
        ...
        label_5->setGeometry(QRect(120, 20, 121, 16));
        label_6 = new QLabel(mywidget);
        label_6->setObjectName("label_6");
        label_6->setGeometry(QRect(500, 20, 141, 16));
        label_7 = new QLabel(mywidget);
        label_7->setObjectName("label_7");
        label_7->setGeometry(QRect(120, 70, 111, 16));
        label_8 = new QLabel(mywidget);
        label_8->setObjectName("label_8");
        label_8->setGeometry(QRect(500, 70, 171, 16));
        pushButton_8 = new QPushButton(mywidget);
        pushButton_8->setObjectName("pushButton_8");
        pushButton_8->setGeometry(QRect(540, 480, 101, 51));
    ...
    void retranslateUi(QWidget *mywidget)
    {
        ...
        pushButton_8->setText(QCoreApplication::translate("mywidget", "package", nullptr));
    } // retranslateUi
